...
export class FavoritesComponent implements OnInit {
  ...
  public sortedFavoriteOffers = signal<SortedFavoriteOffers>(
    this.getSortedOffers(),
  );
  public totalFavorites = computed(() =>
    Object.values(this.sortedFavoriteOffers()).reduce(
  ...
  public isKeyOfSortedFavoriteOffers(
    value: string,
